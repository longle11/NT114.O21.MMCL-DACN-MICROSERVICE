  ...
  const renderOptions = () => {
    ...
    if (Array.isArray(tempArrs) && tempArrs?.length > 0) {
      return tempArrs?.map((data, index) => {
        return <OptionCheckBox is_edited={is_edited} setAddOption={setAddOption} index={index} data={data} positionNewIssueTagAdded={positionNewIssueTagAdded} setPositionNewIssueTagAdded={setPositionNewIssueTagAdded} />
      })
    }
    return <></>
  }
  return (
    <div className='form-group'>
      ...
      <div>
        ...
        {renderOptions()}
        {addOption && is_edited ? <OptionCheckBox is_edited={is_edited} setAddOption={setAddOption} index={-1} data={''} positionNewIssueTagAdded={positionNewIssueTagAdded} setPositionNewIssueTagAdded={setPositionNewIssueTagAdded} /> : <></>}
      </div>
      {is_edited ? <Button
        onClick={() => {
          setAddOption(true)
