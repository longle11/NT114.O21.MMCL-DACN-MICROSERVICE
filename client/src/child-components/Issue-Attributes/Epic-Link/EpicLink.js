        ...
        <div className='row epic-version d-flex align-items-center mt-2'>
            ...
            {props.editAttributeTag === 'epic_link' ? <Select
                ...
                onChange={(value, props) => {
                    ...
                    dispatch(updateInfoIssue(issueInfo?._id.toString(), issueInfo?.project_id?._id.toString(), { epic_link: value }, issueInfo?.epic_link === null ? "None" : issueInfo?.epic_link.epic_name, props.label, userInfo.id, "updated", "epic link", projectInfo, userInfo))
